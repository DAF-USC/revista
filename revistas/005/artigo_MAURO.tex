...
Todo os estudantes de física do universo coñecido escoitamos algunha vez falar
  ...
  clásico que a mecánica cuántica estándar (a chamada Interpretación de
  Copenhague) presentaba e presenta. Así, nun artigo de $1935$
  \cite{schrodinger1} no que discutía a situación da mecánica cuántica e dos
...
\begin{figure}[H] 
	...
	\includegraphics[width=0.7\linewidth]{revistas/005/imaxes/schrodinger1.png}
...
\begin{figure}[H] 
	\centering
	%%%: Metese a figura como sempre. Pódese xogar co ancho pa axustala.
	\includegraphics[width=0.85\linewidth]{revistas/005/imaxes/dobre_fenda.png}
...
\begin{figure}[H] 	
	\centering
	%%%: Metese a figura como sempre. Pódese xogar co ancho pa axustala.
	\includegraphics[width=0.8\linewidth]{revistas/005/imaxes/interferometro.jpg}
