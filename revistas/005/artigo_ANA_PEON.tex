\Bibliografia{bibliografia_005.bib}
...
estruturas de Zariski. Buscaban {\bf A} xeometría. {\bf A 
...
engadir que Zilber segue no seu empeño de atopar {\bf A} 
linguaxe ({\bf A LINGUAXE}) da física dende a teoría de modelos. 
...
Hai outra construcción posible (e equivalente nun sentido adecuado \cite[Remark 2.6]{ZHO}).  Identificamos, 
...
pode enunciar formalmente no mundo da xeometría {\bf complexa} clásica. Pódese se utilizamos os reáis (a clave 
...
é que $L_N$ vive sobre a recta, que {\bf SÍ} que é complexa, no sentido de que podemos coller puntos reáis ou 
complexos sen cambiarmos nada. Un recubrimento finito dunha recta que non é complexo (coma o $L_N$ aquí presente) 
é {\bf MOI} insólito. A súa existencia débese á subxacencia de xeometría non conmutativa. O oscilador armónico é un 
