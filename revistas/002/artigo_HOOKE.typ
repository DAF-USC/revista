...
#columns[
    ...
    #figure(
        image(width: 100%, "/revistas/002/imaxes/17_Robert_Hooke_Engineer.jpg"),
    ...
    da elasticidade que leva o seu nome: $F= -k dot Delta x$. Malia que sexa a
    ...
    A súa _magnum opus_, _Micrographia_, supón un antes e un despois
    ...
    _Micrographia_ é onde se emprega por primeira vez o término «célula»
    ...
    Todo comezou cando, pouco despois da publicación de _Micrographia_,
    ...
    _Opticks_, unha extensa obra escrita por Newton sobre óptica, a cal
    ...
    #figure(
        ...
        image(width: 100%, "/revistas/002/imaxes/Newton-rings.jpg"),
