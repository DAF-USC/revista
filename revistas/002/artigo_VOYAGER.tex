...
Carl Sagan, \textit{Cosmos} (adaptación). % hai que cambiar a cita para pór o reference
...
\begin{center}
    \includegraphics[width=0.7\linewidth]{revistas/002/imaxes/io.jpg}
...
tras décadas de exposición á radiación espacial. Deste ano nunha déecada se
...
Agárdase que a Voyager 1 entre na nube de Oort nuns trescentas anos. Esta é a
...
voando.}>>\\ Carl Sagan, \textit{Pale Blue Dot} (adaptación). % ao igual que antes hai que cambiar a cita

\nocite{stone.ec_1981}
\nocite{smith.ba.soderblom.la.johnson.tv.etal_1979}
\nocite{stone.ec.atreya.sk.anderson.jd.etal_1981}
\nocite{oliver-berry.dmagmmvs_2019}
\nocite{sagan.c_2014}
\nocite{institut.de.physique.du.globe.de.paris_2018}
\nocite{photojournal_jpl_voyager_1}
\nocite{science_nasa_mission_voyager_timeline}
\nocite{nasa_nssdc_gsfc}
\nocite{science_nasa_gallery_voyager-saturn}
\nocite{nasa.jpl_2021}
\nocite{photojournal_jpl_voyager_titan}
