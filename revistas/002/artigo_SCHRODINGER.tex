...
superficies de fase constante} (os frontes de onda da luz), \textbf{as
...
da \textit{eikonal}} da óptica, que é aproximadamente válida para \textbf{ondas
...
\begin{figure}[H]
   ...
   \caption{Ondas localmente planas (Fonte: \cite{apuntes_optica_2})}
\end{figure}

Na mecánica clásica as únicas ondas consideradas serán planas, que dan
...
partículas de enerxía constante. Fixémonos en que agora non se asume unha onda
