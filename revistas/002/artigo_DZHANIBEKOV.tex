...
\vspace{10 pt}
\begin{centering}
    \includegraphics[width=1\linewidth]{revistas/002/imaxes/img1.jpg}
...
achado. Mentres Dzhanibekov desempacaba a subnimistración do envío espacial
...
de velocidade angular ($\vec{\omega}$) e o tensor de inercia ($\mathbb{T}$).
