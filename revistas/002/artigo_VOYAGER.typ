...
#columns[
    ...
    == _Na beira do océano cósmico_

    #set quote(block: true)

    #quote(attribution: [Carl Sagan, _Cosmos_ (adaptación)], [
    ...
    investigacións científicas, entre elas: o _Imaging Science System_
    (ISS), que permitiu capturar espectaculares imaxes do sistema solar; o
    _Infrared interferometer spectrometer and radiometer_ (IRIS), que
    permitiu obter perfís de enerxías e temperaturas; o _Triaxial Fluxgate
    Magnetometer_ (MAG), que investiga os campos magnéticos de planetas e do espazo
    interplanetario; o _Low Energy Charged Particle Instrument_ (LECP), que
    mide propiedades de electróns ou ións de plasma detectados; ou o _Plasma
    Wave Subsystem_ (PWS), que tamén se utiliza no estudo de magnetosferas e da
    ...
    == Viaxe. Navegando polo sistema solar.
    ...
    1 tivo a súa engalaxe a bordo do vehículo de lanzamento _Titan IIE_ tras
    ...
    #figure(
        image(width: 90%, "/revistas/002/imaxes/jupiter.jpg"),
    ...
    #figure(
        image(width: 80%, "/revistas/002/imaxes/io.jpg"),
    ...
    #figure(
        image(width: 80%, "/revistas/002/imaxes/saturno.jpg"),
    ...
    vida, quizais a escala microscópica. A misión _Dragonfly_ enviará unha
    aeronave rotatoria robótica, será lanzada en xullo de 2028 e chegará a Titán en
    2034.

    #figure(
    image(width: 60%, "/revistas/002/imaxes/Dust_storm_on_Titan_pillars_corte.jpg"),
    caption: [Concepción artística dunha tormenta de po en Titán con Saturno de fondo.],
    ) <fig:voya4>

    == Misión estendida. Saíndo do sistema solar.
    ...
    _Retrato de familia_ do sistema solar a petición do astrónomo Carl
    ...
    capturadas pola _Deep Space Network_ da NASA, con complexos en Goldstone
    (California), Madrid e Canberra (Australia) que albergan grandes antenas de ata
    setenta metros de diámetro.

    #figure(
    image(width: 60%, "/revistas/002/imaxes/PaleBlueDot.jpg"),
    caption: [_Pale Blue Dot_: imaxe da Terra tomada
        pola Voyager 1 para o _Retrato de familia_. A Terra, vista
    ...
    Voyager 1 'escoitou' os _sons interestelares_. Vibracións do denso
    ...
    luz do Sol e a un cuarto da distancia deste a _Próxima Centauri_, a
    ...
    viaxando, lonxe de ningunha illa estelar e portando o _Golden Record_.
    ...
    #quote(attribution: [Carl Sagan, _Pale Blue Dot_ (adaptación)], [
    ...
    #SenCita("oliver-berry.dmagmmvs_2019")
    #SenCita("sagan.c_2014")
    #SenCita("science_nasa_mission_voyager_timeline")
    #SenCita("photojournal_jpl_voyager_1")
    #SenCita("nasa_nssdc_gsfc")

    #CrearBibliografia("/revistas/002/bibliografia_VOYAGER.bib")
