...
#show: Artigo.with(
	titulo		: [#emph[Pikadon:] cando o Sol baixa á Terra],
	subtitulo	: [
		Que lle ocorre a un humano na zona cero dunha explosión nuclear?
		Terroríficos debuxos dos superviventes de Hiroshima reflicten o 
...
#align(center)[
	#rect(width: 95%, height: auto)[
		#strong[AVISO]: Os feitos aquí relatados e as imaxes incluídas poden resultar altamente
...
#columns[
	...
	#emph[Little Boy], a bomba que estourou sobre Hiroshima, non detonou ao
	chegar o chan, senón 600 m sobre a superficie. Unha detonación aérea asegura
	que a onda expansiva chegue o máis lonxe posible. #emph[Little Boy] estaba
	...
	vén o alcume #emph[pikadon], literalmente luz estrondosa, que os xaponeses
	deron ás bombas), seguido dunha enorme onda expansiva. A presión xerada por
	#emph[Little Boy] non era suficiente para matar unha persoa, pero si para
	...
	#figure(
		image(
			width: 100%,
			"/revistas/003/imaxes/carbon.jpg"
		),
		caption: [
	...
	#figure(
		image(
			width: 100%,
			"/revistas/003/imaxes/procesion.jpg"
		),
		caption: [
	...
	Como a detonación foi aérea, non houbo cinza radioactiva (#emph[fallout]) na
	...
	#figure(
		image(
			width: 100%,
			"/revistas/003/imaxes/cremacion.jpg"
		),
		caption: [
	...
	#figure(
		image(
			width: 100%,
			"/revistas/003/imaxes/choiva.jpg"
		),
		caption: [
	...
	da poboación xaponesa era tal que os superviventes (#emph[hibakusha]) foron
	...
	== Debuxos dende a zona cero

	Moitas das cousas relatadas polos #emph[hibakusha] poden parecer
	...
	sacadas de @HPMMP:Abomb, e constitúen só unha pequena porción, a menos
	perturbadora, de todos os debuxos producidos polos #emph[hibakusha]. Anímase
	o lector a ver máis imaxes das gardadas en @HPMMP:Abomb.

	#quote(
		attribution: [Tadayoshi Saika, \ No cenotafio de Hiroshima],
		block: true,
	)[
		Descansade en paz, pois non repetiremos o erro.
	]
	...
	#CrearBibliografia("/revistas/003/bibliografia_SANTY_GG.bib")
