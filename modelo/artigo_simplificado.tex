...
%%%: e autor ao índice, reiniciar as contaxes de figuras, e evidentemente imprimir
...
%%%: {TÍTULO}     Evidente, o titulo do artigo. Non debería ser moi longo
%%%: {AUTORÍA}    Autoría do artigo
%%%: {SUBTÍTULO}  Un pequeno texto algo máis explicativo (e posiblemente longo) co
%%%:              titulo, e o único argumento do titular que pode quedar en branco
%%%: {AFILIACIÓN} A afiliación da autoría (se aplica)
\Titular%
{divulgacion}%
{Título}%
{Autoría}%
{Subtítulo}%
{Departamento de Edición, \\ Universidade de Santiago de Compostela}%
...
\begin{figure}[H]
    \centering
%%%: Métese a figura como sempre. Pódese xogar co ancho para axustala.
    \includegraphics[width=0.65\linewidth]{exemplo_imaxe.jpeg}
    \caption{Texto a pé de páxina, interesante...}
    \label{im:exemplo}
\end{figure}
...
\Cita[D'Alembert]{
A álxebra é xenerosa, frecuentemente dá máis do que se lle pide.
}
